 ...
 */
@WebServlet(name = "VinculacionIn32Datos", urlPatterns = {"/VinculacionIn32Datos"})
public class VinculacionIn32Datos extends HttpServlet {
    ...
    private boolean Guardar(String valores, String idUniversidad, String idPeriodo) {
        if (valores.equals("Error")) {
            ...
            try {
                ...
                System.err.println("ERROR VinculacionIn32Datos "+ ex.getMessage());
                return false;
            } finally {
