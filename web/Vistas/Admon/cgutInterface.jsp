<%--
    ...
    Author     : Irvin Joshua Luévano García, Cuauhtemoc Medina Muñoz
--%>
        ...
        <section>
            ...
            <div id="CGUTmenu" class="usual">
                <ul>
                    ...
                    <li id="aProg"><a id="aProg" href="#tabProg" onclick="cargarArchivos('CgutAreas', 'DivContenidoAreas', 'Áreas','aProg');">Programas Educativos</a></li>
                    <li id="aCau"><a id="aCau" href="#tabCau"
                           onclick="cargarArchivos('CgutCausas', 'DivContenidoCausas', 'Causas de Deserción','aCau');">Causas de Deserción</a></li>
                ...
                <div id="tabProg">
                    <%-- Empieza el menú para áreas --%>
                    <ul>
                        <li><a href="#DivContenidoAreas" onclick="cargarArchivos('CgutAreas', 'DivContenidoAreas', 'Áreas','aProg');/*verificarPest();*/">&nbsp;&nbsp;&nbsp;&Aacute;reas</a></li>
                    </ul>
                    <div id="DivContenidoAreas" class="box"></div>

                    <%-- Empieza el menú para familias--%>
                    <ul>
                    ...
                    <%-- Empieza el menú para programas educativos --%>
