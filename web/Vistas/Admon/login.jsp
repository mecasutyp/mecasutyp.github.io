...
<html>
    <head>
        <meta name="keywords" content="mecasut, MECASUT, planeación, coordinación, general, universidades, tecnologicas, politecnicas" />
        <meta name="Description" content="Descripción de sitio web hecha" />
