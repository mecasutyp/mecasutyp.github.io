                ...
                //AÑOS ESCOLARES
                 while (rs.next() && (rs.getString("id_nivel").equals("1") ||rs.getString(1).equals("2") ||rs.getString(1).equals("3") )) {//while de niveles
                    ...
                    tablas = tablas.concat("</tr>");
                        ...
                        tablas = tablas.concat("<tr>");
                        tablas = tablas.concat("<td colspan='13' class='rounded-foot-left'>Notas: Se encuestará al menos a ")
                                .concat(String.valueOf(muestreo))
                                .concat(" personas, por disposici&oacute;n de la CGUT. Atención, por lo anterior la columna 'H' debe ser igual o mayor a la cantidad mencionada.</td>");
