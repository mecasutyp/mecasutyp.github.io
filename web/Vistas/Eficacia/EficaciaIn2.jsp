        ...
        <%
            ...
            try {
                ...
                while (rs2.next()) {
                    ...
                    conta = 1;
                    //TITULOS                             
                    tablas = tablas.concat("<h2><a onclick='operacionesEficaciaIn2(" + conC + ");' href='#'> Cuadro 2.1.").concat(rs2.getString("id_nivel")).concat("<br/>");
                    tablas = tablas.concat("Aprovechamiento Acad&eacute;mico del Nivel ").concat(rs2.getString("descripcion")).concat(" (con Competencias Profesionales) Seg&uacute;n Carrera").concat("</a></h2>");
                    ...
                    while (rs.next()) {
                        ...
                        if (rs6.next()) {
                            ...
                            tablas = tablas.concat("<td align='center'>").concat(rs.getString("nombre_programa")).concat(" ("+rs.getString("version")+")").concat("</td>");
                            tablas = tablas.concat("<td align='center'><input style='width:90%' maxlength='4' id='" + rs.getString("id_pe") + "' type='text' name='sep-dic_" + conC + "_" + conta + "' value='".concat(rs6.getString("sep")).concat("' onblur='indicador2(this," + conC + "," + rs.getString("version") + ");'></td>"));
                            tablas = tablas.concat("<td align='center'><input style='width:90%' maxlength='4' type='text' name='ene-abril_" + conC + "_" + conta + "' value='".concat(rs6.getString("ene")).concat("' onblur='indicador2(this," + conC + "," + rs.getString("version") + ");'></td>"));
                            tablas = tablas.concat("<td align='center'><input style='width:90%' maxlength='4' type='text' name='may-ago_" + conC + "_" + conta + "' value='".concat(rs6.getString("may")).concat("' onblur='indicador2(this," + conC + "," + rs.getString("version") + ");'></td>"));
                            ...
                            tablas = tablas.concat("<td>".concat(String.valueOf(conta).concat("</td>")));
                            tablas = tablas.concat("<td align='center'>").concat(rs.getString("nombre_programa")).concat(" ("+rs.getString("version")+")").concat("</td>");
                            tablas = tablas.concat("<td align='center'><input style='width:90%' maxlength='4' id='" + rs.getString("id_pe") + "' type='text' name='sep-dic_" + conC + "_" + conta + "' value='0.0'  onblur='indicador2(this," + conC + "," + rs.getString("version") + ");'></td>");
                            tablas = tablas.concat("<td align='center'><input style='width:90%' maxlength='4' type='text' name='ene-abril_" + conC + "_" + conta + "' value='0.0'  onblur='indicador2(this," + conC + "," + rs.getString("version") + ");'></td>");
                            tablas = tablas.concat("<td align='center'><input style='width:90%' maxlength='4' type='text' name='may-ago_" + conC + "_" + conta + "' value='0.0'  onblur='indicador2(this," + conC + "," + rs.getString("version") + ");'></td>");
                            tablas = tablas.concat("<td align='center'><input readonly=\"readonly\" id=\"etiqueta\" style='width:90%' type='text' name='promCal" + conC + "_" + conta + "' value='0'></td>");
                            tablas = tablas.concat("<tr>");
                        }
                        conta++;
                ...
                if (rs5.next()) {
                    ...
                    int cont = 1;
                    //TITULOS
                    tablas = tablas.concat("<h2><a href='#' onclick='operaciones2v2004(" + conC + ");'>Cuadro 2.1.").concat(rs2.getString("id_nivel")).concat("</br>");
                    ...
                    while (rs3.next()) {
                        ...
                        if (rs7.next()) {
                            ...
                            tablas = tablas.concat("<td align='center'>").concat(rs3.getString("nombre_programa")).concat(" ("+rs3.getString("version")+")").concat("</td>");
                            tablas = tablas.concat("<td align='center'><input style='width:90%' maxlength='3' id='" + rs3.getString("id_pe") + "' type='text' name='sep-dic_" + conC + "_" + conta + "' value='".concat(rs7.getString("sep")).concat("' onblur='indicador2(this," + conC + "," + rs3.getString("version") + ");'></td>"));
                            tablas = tablas.concat("<td align='center'><input style='width:90%' maxlength='3' type='text' name='ene-abril_" + conC + "_" + conta + "' value='".concat(rs7.getString("ene")).concat("' onblur='indicador2(this," + conC + "," + rs3.getString("version") + ");'></td>"));
                            tablas = tablas.concat("<td align='center'><input style='width:90%' maxlength='3' type='text' name='may-ago_" + conC + "_" + conta + "' value='".concat(rs7.getString("may")).concat("' onblur='indicador2(this," + conC + "," + rs3.getString("version") + ");'></td>"));
                            tablas = tablas.concat("<td align='center'><input readonly=\"readonly\" id=\"etiqueta\" style='width:90%' type='text'  name='promCal" + conC + "_" + conta + "' value='0'></td>");
                            tablas = tablas.concat("<tr>");
                        } else {
                            tablas = tablas.concat("<tr>");
                            tablas = tablas.concat("<td>".concat(String.valueOf(cont).concat("</td>")));
                            tablas = tablas.concat("<td align='center'>").concat(rs3.getString("nombre_programa")).concat(" ("+rs3.getString("version")+")").concat("</td>");
                            tablas = tablas.concat("<td align='center'><input style='width:90%' maxlength='3' id='" + rs3.getString("id_pe") + "' type='text' name='sep-dic_" + conC + "_" + conta + "' value='0' onblur='indicador2(this," + conC + "," + rs.getString("version") + ");'></td>");
                            tablas = tablas.concat("<td align='center'><input style='width:90%' maxlength='3' name='ene-abril_" + conC + "_" + conta + "' value='0' onblur='indicador2(this," + conC + "," + rs3.getString("version") + ");'></td>");
                            tablas = tablas.concat("<td align='center'><input style='width:90%' maxlength='3' name='may-ago_" + conC + "_" + conta + "' value='0' onblur='indicador2(this," + conC + "," + rs3.getString("version") + ");'></td>");
                            tablas = tablas.concat("<td align='center'><input readonly=\"readonly\" id=\"etiqueta\" style='width:90%' type='text' name='promCal" + conC + "_" + conta + "' value='0'></td>");
                            tablas = tablas.concat("<tr>");
                        }
                        cont++;
...
//Creacion de los totales
                ...
                ResultSet rs3 = con.Consultar(sql3);
                   String sql6 = "Select (max(id_nivel)+1) as id_nivel from nivel_pe";
                 rsmaxnivel = con.Consultar(sql6);
                    rsmaxnivel.next();
                    
                while (rs3.next()) {
                    // competencias = true;
              
                    tablas = tablas.concat("<h2><a href='#' onclick='totalAprovechamiento();'> Cuadro 2.2</br>");
                    tablas = tablas.concat("Aprovechamiento Acad&eacute;mico de la Universidad por Competencias").concat("</a></h2>");
...
//TOTALES CON VERSION 2004
                if (rs5.next()) {
                    int cont = 1;
                    //TITULOS
                    tablas = tablas.concat("<h2><a href='#' onclick='totalAprovechamiento2004();'> Cuadro 2.").concat(rsmaxnivel.getString("id_nivel")).concat("</br>");
                    tablas = tablas.concat("Aprovechamiento Acad&eacute;mico de la Universidad").concat("</a></h2>");
                    tablas = tablas.concat("<div><table id='rounded-corner' style='width: 100%'>");
                    tablas = tablas.concat("<thead>");
                    tablas = tablas.concat("<tr>");
                    tablas = tablas.concat("<th scope='col' rowspan='2' class='rounded-company'>No</th>");
...
// VERSION 2004 EN CASO DE EXISTIR EN EL PROGRAMA EDUCATIVO
                ...
                System.err.println("Error eficacia2: " + ex);
            } finally {
                con.Desconectar();
                rs.close();
                rs5.close();
...
<%      //SE CONSULTA INDICADOR 
        String consulta = "SELECT comentario FROM comentarios WHERE "
            ...
            + "id_periodo="+ sesion.getAttribute("idPeriodo").toString()+" AND indicador=2";
...
%>
                <input type="text" id="comentario2" name="comentario2" style=" width: 90%; " value="<%= comentario %>"/>
            </th>
        </tr>
    </table>
    <%
