            ...
            try 
            {
                ...
                if (rs5.getString("suma") != null) 
                {
                    ...
                    while(rs.next())
                    {
                        ...
                        if (rs3.next()) 
                        {
                            ...
                            if (rs.getInt("id_nivel") == 1 || rs.getInt("id_nivel") == 2) 
                            {
                                ...
                                tabla6 = tabla6.concat("<td width='20%'>Egresados ").concat(String.valueOf(rs3.getInt("anio"))).concat(" cuya actividad laboral es acorde a su formación académica por programa educativo</td>");
                            } else 
                            {
                                ...
                                tabla6 = tabla6.concat("<td width='20%'>Egresados ").concat(String.valueOf(rs3.getInt("anio") + 1)).concat(" cuya actividad laboral es acorde a su formación académica por programa educativo</td>");
                    ...
                    while(rs.next())
                    {
                        ...
                        tabla6 = tabla6.concat("Egresados de ").concat(rs.getString("n.descripcion")).concat("  incorporados al mercado laboral y que trabajan en área afín por sector</a></h3>");
                        tabla6 = tabla6.concat("<div align='center'><table width='60%' id='rounded-corner'>");
                        tabla6 = tabla6.concat("<thead>");
                        tabla6 = tabla6.concat("<tr>");
