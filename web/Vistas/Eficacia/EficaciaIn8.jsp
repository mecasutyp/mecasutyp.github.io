                        ...
                        if (rs1.next()) {
                            ...
                            if (!rs3.getString("pe.id_nivel").equals("2")) {
                                if (!rs3.getString("pe.id_nivel").equals("3")) {
                                    ...
                                    tablas = tablas.concat("<th class='rounded-q1'>Egresados de ".concat(String.valueOf(rs1.getInt("anio"))).concat(" con testimonio de desempeño sobresaliente del ").concat(ex).concat("</h2>"));
                                    tablas = tablas.concat("<th class='rounded-q1'>Egresados de ".concat(String.valueOf(rs1.getInt("anio"))).concat(" con testimonio de desempeño satisfactorio del ").concat(ex).concat("</h2>"));
                                    ...
                                    tablas = tablas.concat("<th class='rounded-q1'>Egresados de ".concat(String.valueOf(rs1.getInt("anio") + 1)).concat(" con testimonio de desempeño sobresaliente del ").concat(ex).concat("</h2>"));
                                    tablas = tablas.concat("<th class='rounded-q1'>Egresados de ".concat(String.valueOf(rs1.getInt("anio") + 1)).concat(" con testimonio de desempeño satisfactorio del ").concat(ex).concat("</h2>"));
