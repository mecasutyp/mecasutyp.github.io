...
<html>
    <head>
        <meta name="google-site-verification" content="x5Nyk5n8J8yu7wfU99zx1hac6AIOhFPxyXi8L2ejvik" />
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <meta http-equiv="Pragma" content="no-cache" />
        <meta name="Description" content="Con la finalidad de permitir a la sociedad y al estado, mostrar y constatar con transparencia el logro de objetivos y metas trazadas en las Universidades Tecnológicas y Politécnicas, la Coordinación General de Universidades Tecnológicas y Politécnicas (CGUTyP) se dio a la tarea de crear un instrumento para evaluar a estas denominado: “Modelo de Evaluación de la Calidad del Subsistema de Universidades Tecnológicas (MECASUT)”" />
    ...
    <body>
                ...
                <tr>
                    <td>
                        ...
                        <select name="report" id="report" onchange="validar();">
                            ...
                            <option value="repprog">Reporte de programas</option>
        ...
        <div id="menu" style="width: 70%; position: absolute; top: 128px; z-index :98" >
            <ul class="menu">
                ...
                <li><a href="#" class="parent"><span>Inicio</span></a>
                    <div>
                        <ul>
                            ...
                            <li><a href="#" onclick="$( '#formErrores' ).dialog( 'open' );"><span>Reportar un fallo en el Sistema</span></a></li>
                        </ul>
                    </div>
                </li>
                <%
                ...
                <li id="iniEv"><a href="#" class="parent"><span>Iniciar Evaluaci&oacute;n</span></a>
                 ...
                 <li><a href="#" class="parent"><span>Guías</span></a>
                    <div>
                        <ul>
                            <li><a href="#" onclick="window.open('/descargarGuia','_blank');"><span>Gu&iacute;a del Sistema (PDF)</span></a></li>
                            <li><a href="#" onclick="window.open('/descargarGuiaGeneral','_blank');"><span>Gu&iacute;a General MECASUT (PDF)</span></a></li>
        ...
        <div id="formErrores" title="Reportar un error en la aplicaci&oacute;n" style="display: none;">
            <p>Puede reportar un error en el Sistema o enviar un comentario o sugerencia.
                <br/>
                Primero debe elegir hacia qui&eacute;n va dirigido el reporte, si es a un administrador del Sistema o a los desarrolladores.
            </p>
            Los administradores de la Sistema son personas de la CGUT que conocen el proceso del MECASUT y pueden solucionar cuestiones como las siguentes:
            <ul>
            ...
            Los desarrolladores son las personas que crearon el Sistema y pueden resolver problemas t&eacute;cnicos o cuestiones como las siguentes:
            <ul>
                ...
                <li>No se puede cargar alg&uacute;n indicador o se queda mostrando un mensaje que no se puede cerrar</li>
