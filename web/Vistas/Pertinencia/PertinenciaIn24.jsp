...
try{
            ...
            try {
                ...
                System.err.println("Jsp error pertinencia 24: "+ex);
            } finally {
                con.Desconectar();
            }
%>
...
<html:form action="/PertinenciaIn24">
    ...
    <div id="pert24" align="center">
        <h3><a href="#">Cuadro 24.1<br/>Nivel de Estudios de los Profesores de Asignatura</a></h3>
        <div>
            ...
            <table id="rounded-corner" style="width: 70%">
                <thead>
                    ...
                    <tr>
                        ...
                        <th class="rounded-q1">Sin trabajo en los ultimos tres años</th>
                        <th class="rounded-q1" width="30%" >Sin trabajo más de tres años</th>
                    </tr>
                </thead>
                <tr>
...
<%      //SE CONSULTA INDICADOR 
        String consultacom = "SELECT comentario FROM comentarios WHERE "
            ...
            + "id_periodo="+ sesion.getAttribute("idPeriodo").toString()+" AND indicador=24";
