...
<%try {
    ...
    try {
        ...
        if (cons1.next()) {
            pct = cons1.getString("prof_tc");
        }

    } catch (SQLException ex) {
        System.err.println("jsp error pertinencia 23: " + ex);
    } finally {
        con.Desconectar();
    }
%>
...
<html:form action="/PertinenciaIn23">
    ...
    <div id="pert23">
        <h2>Cuadro 23.1<br/>Nivel de Estudios de los Profesores de Tiempo completo</h2>
        <div align="center">
            ...
            <table align="center" id="rounded-corner" style="width: 100%">
                <thead>
                    <tr>
                        ...
                        <th rowspan="2" class="rounded-q1">Cuentan con perfil PRODEP</th>
...
<%      //SE CONSULTA INDICADOR 
        String consultacom = "SELECT comentario FROM comentarios WHERE "
            ...
            + "id_periodo="+ sesion.getAttribute("idPeriodo").toString()+" AND indicador=23";
