<%-- 
    ...
    Author     : Cuauhtemoc Medina Muñoz, Daniel Ramírez Torres
--%>
            ...
            <table id="rounded-corner" style="width: 100%">
                <thead>
                    <tr>
                        ...
                        <th width='8%' class="rounded-q1">Año de incio </br>de la carrera</th>
                        <th width='8%'class="rounded-q1">Año del &uacute;ltimo </br>estudio de</br>factibilidad</th>
                        <th width='9%' class="rounded-q1">Año del &uacute;ltimo </br>estudio de an&aacute;lisis</br> de la situaci&oacute;n de trabajo</th>
