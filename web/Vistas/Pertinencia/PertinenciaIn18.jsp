...
<html:form action="/PertinenciaIn18">
    <div id="pert18">
        ...
        <h2 onclick="blurVal18(<%=cuadro%>);">Cuadro 18.1.<%=niv.getString("id_nivel")%>
            ...
            <br/>Relaci&oacute;n de programas educativos de <%=niv.getString("descripcion")%> con evaluaci&oacute;n diagn&oacute;stica según nivel</h2>
        <div>
            <table id="rounded-corner" style="width: 100%">
                ...
                <tr>
                    <td align="center" colspan="2">DISTRIBUCIÓN PORCENTUAL</td>
        ...
        <h2>Cuadro 18.2.<%=niv.getString("id_nivel")%><br/>Relaci&oacute;n de la matr&iacute;cula en programas educativos de <%=niv.getString("descripcion")%>  con evaluación diagnóstica según nivel de evaluaci&oacute;n</h2>
        <div>
