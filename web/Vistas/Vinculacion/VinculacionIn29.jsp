        ...
        <%
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    if (rs3.next()) {
                        tablas = tablas.concat("<tr>");
                        tablas = tablas.concat("<td align='center'>Egresados del nivel ").concat(rs.getString("n.descripcion")).concat("</td>");
...
<%      //SE CONSULTA INDICADOR 
        String consultacom = "SELECT comentario FROM comentarios WHERE "
            ...
            + "id_periodo="+ sesion.getAttribute("idPeriodo").toString()+" AND indicador=29";
