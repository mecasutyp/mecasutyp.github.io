    ...
    <div id="vinc30">
        ...
        <div><table id='rounded-corner' style='width: 100%'>
                ...
                <tr>
                    ...
                    <td align='center'><input maxlength='6' style='width:90%' type='text' name='val1' value="<%=rs.getString("d_capacitacion")%>" onblur='indicador30(this);' ></td>
                    <td align='center'><input maxlength='6' style='width:90%' type='text' name='val2' value="<%=rs.getString("d_actualizacion")%>" onblur='indicador30(this);' ></td>
                    <td align='center'><input maxlength='6' style='width:90%' type='text' name='val3' value="<%=rs.getString("d_desarrollo")%>" onblur='indicador30(this);' ></td>
                ...
                <tr>
                    ...
                    <td align='center'><input maxlength='6' style='width:90%' type='text' name='val4' value="<%=rs.getString("o_capacitacion")%>" onblur='indicador30(this);' ></td>
                    <td align='center'><input maxlength='6' style='width:90%' type='text' name='val5' value="<%=rs.getString("o_actualizacion")%>" onblur='indicador30(this);' ></td>
                    <td align='center'><input maxlength='6' style='width:90%' type='text' name='val6' value="<%=rs.getString("o_desarrollo")%>" onblur='indicador30(this);' ></td>
                ...
                <%                                }
                        ...
                        System.err.println("JSPERROR-VinculacionIn30:" + ex.getMessage());
                    } finally {
                        con.Desconectar();
                    }
                %>
...
<%      //SE CONSULTA INDICADOR 
        String consultacom = "SELECT comentario FROM comentarios WHERE "
            ...
            + "id_periodo="+ sesion.getAttribute("idPeriodo").toString()+" AND indicador=30";
