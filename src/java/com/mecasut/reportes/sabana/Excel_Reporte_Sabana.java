...
public class Excel_Reporte_Sabana extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (ask.equals("sabana")) {
            ...
            try {
                limpiarBasurero();
                System.out.println("Generando Sabana...");
                /*LISTAS NECESARIAS*/
                ListaUniversidades univs = new ListaUniversidades(periodo);
                ListaNiveles niveles = new ListaNiveles(false);
                /*EFICACIA*/
                SabanaEficacia eficacia = new SabanaEficacia(anio, obj, periodo, univs, niveles);
                obj = eficacia.hacerEficacia();
                eficacia = null;
                /*EFICIENCIA*/
                SabanaEficiencia eficiencia = new SabanaEficiencia(anio, obj, periodo, univs, niveles);
                obj = eficiencia.hacerEficiencia();
                eficiencia = null;
                /*PERTINENCIA*/
                SabanaPertinencia pertinencia = new SabanaPertinencia(anio, obj, periodo, univs, niveles);
                obj = pertinencia.hacerPertinencia();
                pertinencia = null;
                /*VINCULACION*/
                SabanaVinculacion vinculacion = new SabanaVinculacion(anio, obj, periodo, univs, niveles);
                obj = vinculacion.hacerVinculacion();
                vinculacion = null;
                /*EQUIDAD*/
                SabanaEquidad equidad = new SabanaEquidad(anio, obj, periodo, univs, niveles);
                ...
                niveles = null;
                /*IMPRIMIR EL EXCEL*/
                EnviarExcel(response, obj.getLibro(), "Sabana " + anio + "- " + (Integer.parseInt(anio) + 1));
                obj = null;
                limpiarBasurero();
                ...
                System.err.println("OUT OF MEMORY personalizado by Cuauh Medina: \n "
    ...
    private void EnviarExcel(HttpServletResponse response, Workbook libro, String nombreArchivo) {
        try {
            ...
            fileOut.flush();
            fileOut.close();
            System.out.println("Sabana Generada");
        } catch (Exception e) {
