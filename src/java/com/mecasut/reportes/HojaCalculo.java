...
public class HojaCalculo {
    ...
    public void val(int columna, int fila, int valor) {
        try {
            ...
            System.err.println("ERROR: HOJA CALCULO MÉTODO VAL" + ex.getMessage());
        }
    }
    ...
    public void val(int columna, int fila, String valor) {
        try {
            celdas[columna][fila].setCellValue(valor);
        } catch (Exception ex) {
            System.err.println("ERROR: HOJA CALCULO MÉTODO VAL" + ex.getMessage());
    ...
    public void val(int columna, int fila, String valor, String estilo) {
        try {
            celdas[columna][fila].setCellValue(valor);
            setStyle(columna, fila, estilo);
        } catch (Exception ex) {
