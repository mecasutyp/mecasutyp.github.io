        ...
        if (ask.equals("Info")) {
            ...
            try {
                ...
                if(telpartido.length>1){
                    cell = new PdfPCell(new Paragraph("Lada: "+telpartido[0]+"   Teléfono: " + telpartido[1]));
                }else{
                ...
                if (rsAcad.next()) {
                    ...
                    cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                    table.addCell(cell);
                    cell = new PdfPCell(new Paragraph("Profesores de tiempo completo trabajando actualmente: " + rsAcad.getString(5)));
                    cell.setFixedHeight(alto);
                    cell.setBorder(PdfPCell.NO_BORDER);
                    cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                    table.addCell(cell);
                ...
                while (rsNivel.next()) {
                    table = new PdfPTable(1);
                    document.add(new Paragraph("Información y programas educativos que se ofrecen del nivel " + rsNivel.getString("n.descripcion") + ": ", FUENTE_TITULOS));
                    Paragraph sub = new Paragraph("Modelos de impartición de clases del nivel " + rsNivel.getString("n.descripcion") + ":", FUENTE_SUBTITULOS);
                    ...
                    document.add(table);
                    table = new PdfPTable(1);
                    sub = new Paragraph("Programas educativos que se ofrecen para el nivel " + rsNivel.getString("n.descripcion") + ":", FUENTE_SUBTITULOS);
                    sub.setAlignment(Element.ALIGN_CENTER);
                    document.add(sub);
